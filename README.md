...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&amp;color=0:6d28d9,50:a855f7,100:e879f9&amp;height=220&amp;section=header&amp;text=7Vixen&amp;fontSize=90&amp;fontAlignY=38&amp;animation=twinkling&amp;fontColor=ffffff&amp;desc=Visual+Computing+%7C+AI+%26+ML+Engineer&amp;descAlignY=58&amp;descSize=22"/>
...
const yousra = {
    ...
    level: "M1 Student — Computer Science (Visual Track)",
    location: "🌍 Somewhere between pixels, vectors, and tensors",
    ...
    philosophy: {
        ...
        ai:           "Prompts are the new code — craft them with precision",
    ...
    dailyRoutine: [
        ...
        "🧠 Train models, debug intuitions",
        "✍️  Craft prompts like poetry",
        "📚 Read one paper a day",
        "🌙 Dream in latent space"
    ]
};
```
...
<details open>
<summary><b>🧠 RAG Pipeline — Document Intelligence System</b></summary>
<br/>

> **Retrieval-Augmented Generation** — Connecting raw documents to meaningful answers
...
**Highlights:**
- 📄 Multi-format document ingestion (PDF, MD, DOCX)
...
<details>
<summary><b>🎨 Visual Prompt Studio — Prompt Engineering Toolkit</b></summary>
<br/>

> **Prompt Optimization Platform** — Craft, test, and iterate prompts with precision
...
Feature:   A/B prompt comparison & scoring
```
...
<details>
<summary><b>🖼️ Neural Style Transfer — Visual Computing Project</b></summary>
<br/>

> **Real-Time Artistic Style Transfer** — Merging content and aesthetics through deep learning

```yaml
Model:     VGG-19 Feature Extraction
Loss:      Content Loss + Gram Matrix Style Loss
Interface: Streamlit Web App
Output:    High-res stylized images
```
...
+ Generative Models & Diffusion      ████████████████████░ 85%
+ Computational Photography          ████████████████████░ 88%
```

### 🧠 AI / Machine Learning
```diff
+ Deep Learning & Neural Architectures  ████████████████████░ 90%
+ NLP & Large Language Models           ████████████████████░ 88%
+ Prompt Engineering & RAG Systems      ████████████████████░ 94%
...
+ DevOps & Containerization          ████████████████████░ 78%
+ Research & Technical Writing       ████████████████████░ 91%
```
...
```yaml
On Visual Computing:
  - "The world is a dataset — learn to see it differently"
...
On AI:
  ...
  - Prompts are spells — precision is power
...
### 📫 **Open for:**
**Research Collaborations** • **AI Projects** • **Visual Computing** • **Open Source** • **Internships**
